# Contributing to html-string-to-pdf
...
- **Check the documentation** - Your question might be documented
...
2. Clone your fork: `git clone https://github.com/nurmhm/fast-html-pdf.git`
...
By contributing to html-string-to-pdf, you agree that your contributions will be licensed under its MIT License.
